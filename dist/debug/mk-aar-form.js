(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("MK.utils"), require("react-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["MK.utils", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["MKAarForm"] = factory(require("MK.utils"), require("react-dom"));
	else
		root["MKAarForm"] = factory(root["MK"]["utils"], root["ReactDOM"]);
...
var _mkUtils = __webpack_require__(81);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.fieldChange = function () {
        var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(fieldPath, value, checkFn) {
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return _this.check([{ path: fieldPath, value: value }], checkFn, true);
    ...
    this.check = function () {
        var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(option, checkFn, needSaveFieldValue) {
            var checkResults, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, child, checkResult, hasError, json;

            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            if (!(!option || !_mkUtils2.default._.isArray(option))) {
                                _context2.next = 2;
                                break;
                            }
                        ...
                        case 2:
                            ...
                            _context2.prev = 6;
                            _iterator = (0, _getIterator3.default)(option);
                        ...
                        case 8:
                            ...
                            _context2.next = 14;
                            return checkFn({ path: child.path, value: child.value });
            ...
            }, _callee2, _this, [[6, 21, 25, 33], [26,, 28, 32]]);
        }));
